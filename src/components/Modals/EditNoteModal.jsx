...
const EditNoteModal = ({product}) => {
  ...
  return (  
  <Popup
    trigger={<button className="addNote__btn" type='button'> 
      <img 
        src={'https://firebasestorage.googleapis.com/v0/b/lista-super-app.appspot.com/o/assets%2FeditMyListIcon.svg?alt=media&token=10f9b52b-11df-41fa-a751-b39fffd16b76'} 
        alt="E" /> 
    </button>}
    modal
    nested
